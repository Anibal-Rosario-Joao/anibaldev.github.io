...
const translations = {
  pt: {
    ...
    project1Title: 'Aplicativo de Loteria',
    project1Description: 'Lottery App é um aplicativo Android desenvolvido com Kotlin e Jetpack Compose, usando MVVM, Material 3, Navigation Compose e Room para armazenamento local de dados.',
    project2Title: 'Aplicativo de Burguer King',
    project2Description: 'King Burger é um app Android feito com Kotlin e Jetpack Compose, usando MVVM e Clean Architecture, com API REST, autenticação e navegação moderna',
  ...
  en: {
    ...
    project1Title: 'Lottery App',
    project1Description: 'Lottery App is an Android app built with Kotlin and Jetpack Compose, using MVVM, Material 3, Navigation Compose, and Room for local data storage.',
    project2Title: 'Burguer King App',
    project2Description: 'King Burger is an Android app built with Kotlin and Jetpack Compose, using MVVM and Clean Architecture, with REST API, authentication, and modern navigation.',
